...
<Figure
  src="/blog/startup-runway-burn-rate-guide/hero.webp"
  alt="Contemporary open office space with people collaborating and working together."
  priority
  credit={{ name: "Startup Stock Photos", url: "https://www.pexels.com/@startup-stock-photos" }}
/>
...
<Figure
  src="/blog/startup-runway-burn-rate-guide/mid.webp"
  alt="Modern laptop on a wooden desk beside an hourglass, symbolizing time and technology intersection."
  credit={{ name: "Burak The Weekender", url: "https://www.pexels.com/@weekendplayer" }}
/>
...
<Figure
  src="/blog/startup-runway-burn-rate-guide/bottom.webp"
  alt="An adult man working at a desk on a laptop with a smartphone nearby, in a dimly lit home office."
  credit={{ name: "Faye Tsui", url: "https://www.pexels.com/@faye-tsui-331490536" }}
/>
