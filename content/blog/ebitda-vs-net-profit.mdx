...
<Figure
  src="/blog/ebitda-vs-net-profit/hero.webp"
  alt="A financial statement on a wooden desk with colorful pens, ideal for accounting themes."
  priority
...
<Figure
  src="/blog/ebitda-vs-net-profit/mid.webp"
  alt="A businessman in a black suit using a calculator at a desk with financial documents and a laptop."
  credit={{ name: "RDNE Stock project", url: "https://www.pexels.com/@rdne" }}
/>
...
<Figure
  src="/blog/ebitda-vs-net-profit/bottom.webp"
  alt="Close-up of a balance sheet under a magnifying glass on a wooden table."
  credit={{ name: "RDNE Stock project", url: "https://www.pexels.com/@rdne" }}
/>
